...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_SYMBOLS] = LAYOUT( \
      ...
      TO(3),   KC_AMPR, KC_ASTR, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_0,    KC_DOT,  KC_EQUAL,KC_TRNS \
      ),
   ...
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * | Tab  |   '  |   ,  | MS_UP|   P  |   Y  |             |   F  |   G  | WH_UP|   R  |   L  | Del  |
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
  ...
  [_MOUSE] = LAYOUT( \
      ...
      KC_TRNS, KC_TRNS, KC_COMM, KC_MS_U, KC_TRNS, KC_TRNS,                   KC_TRNS, KC_TRNS, KC_WH_U, KC_R,    KC_L,    KC_TRNS, \
